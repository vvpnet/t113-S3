...
define GST1_RTSP_SERVER_INSTALL_TEST_LAUNCH
	$(INSTALL) -D -m 0755 $(@D)/build/examples/test-launch $(TARGET_DIR)/usr/bin/
endef
GST1_RTSP_SERVER_POST_INSTALL_STAGING_HOOKS += GST1_RTSP_SERVER_INSTALL_TEST_LAUNCH
