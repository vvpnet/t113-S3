...
UBOOT_BOOT_IMAGE = $(call qstrip,$(BR2_TARGET_UBOOT_BOOT_IMAGE))
...
define UBOOT_BUILD_CMDS
	$(if $(UBOOT_CUSTOM_DTS_PATH),
		cp -rf $(UBOOT_CUSTOM_DTS_PATH) $(@D)/arch/$(UBOOT_ARCH)/dts/
		cp -rf $(UBOOT_CUSTOM_DTS_PATH) $(@D)/dts/upstream/src/$(UBOOT_ARCH)
	)
	$(TARGET_CONFIGURE_OPTS) \
